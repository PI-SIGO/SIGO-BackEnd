...
{
    /// <inheritdoc />
    public partial class FixOpcoesCadastroTiposMarca : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                """
                CREATE OR REPLACE VIEW vw_opcoes_cadastro AS
                ...
                FROM (
                    ...
                    FROM oficina AS o
                    CROSS JOIN (
                        SELECT DISTINCT BTRIM(m.tipomarca) AS valor
                        FROM marca AS m
                        WHERE m.tipomarca IS NOT NULL
                          AND BTRIM(m.tipomarca) <> ''
                    ) AS tipos_marca
